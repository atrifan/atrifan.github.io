...
const TOOLS_DOCUMENTATION = [
  ...
  },
  {
    ...
    description: 'Find the next upcoming solar or lunar eclipse. Optionally filter by type and check visibility for a location.',
    category: 'Astronomy',
    hasWidget: true,
    inputSchema: {
      type: 'object',
  ...
  },
  {
    ...
    description: 'List upcoming solar and lunar eclipses with dates, types, and visibility info.',
    category: 'Astronomy',
    hasWidget: true,
    inputSchema: {
      type: 'object',
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        cycleLength: { type: 'integer', description: 'Average cycle length in days (default: 28)' },
        periodLength: { type: 'integer', description: 'Average period length in days (default: 5)' },
      },
      required: [],
    },
    outputSchema: {
  ...
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        mode: { type: 'string', enum: ['riskAndSL', 'riskOnly'], description: 'Calculation mode' },
